...
class Proveedor < ActiveRecord::Base
  ...
  def verificar_borrado
    errors.add("Albaran", "El proveedor no se puede borrar. Tiene asociados albaranes") unless self.albaranes.empty?
  ...
  def productos_comprados
    albaranes = self.albaranes.all :conditions => { :cerrado => true }, :order => "fecha desc"
