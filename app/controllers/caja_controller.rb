class CajaController < ApplicationController
  ...
  def arqueo 
    ...
    @pagos.each do |pago|
      @importe_ventas += pago.importe if pago.factura && !pago.factura.albaranes.empty? && pago.factura.albaranes.first.cliente
      @importe_compras += pago.importe if pago.factura && !pago.factura.albaranes.empty? && pago.factura.albaranes.first.proveedor
      @importe_gastos += pago.importe if pago.factura && pago.factura.albaranes.empty? && pago.factura.proveedor
